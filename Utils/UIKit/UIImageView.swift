...
class CustomUIImageView: UIImageView {
    ...
    @IBInspectable var blendMode: Int32 = 0 {didSet{setNeedsLayout()}}
    @IBInspectable var blendAlpha: CGFloat = 0 {didSet{setNeedsLayout()}}
    @IBInspectable var blendColor: UIColor = .clear {didSet{setNeedsLayout()}}
